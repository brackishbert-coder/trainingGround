...
public class Chance implements RoundAction {
	...
	public Chance(PlayerWrper player, Status status, ArrayList<BoardSpace> freeSpaces,
			HashMap<PlayerWrper, ArrayList<BoardSpace>> takenSpaces) {
				...
				this.setTakenSpaces(takenSpaces);
	...
	public PlayerWrper getPlayer() {
		return player;
	}

	public void setPlayer(PlayerWrper player) {
		this.player = player;
	}

	public ArrayList<BoardSpace> getFreeSpaces() {
		return freeSpaces;
	}

	public void setFreeSpaces(ArrayList<BoardSpace> freeSpaces) {
		this.freeSpaces = freeSpaces;
	}

	public HashMap<PlayerWrper, ArrayList<BoardSpace>> getTakenSpaces() {
		return takenSpaces;
	}

	public void setTakenSpaces(HashMap<PlayerWrper, ArrayList<BoardSpace>> takenSpaces) {
