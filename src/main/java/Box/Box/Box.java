...
import Box.Grouper.FlowPreprocessor;
...
public class Box extends Thread {
	...
	public static void main(String[] args) {
		...
		try (java.util.Scanner scanner = new java.util.Scanner(
				new java.io.File("/home/wes/gitworkspace/trainingGround/TEST/tests"))) {
...
//	
//			try (java.util.Scanner scanner = new java.util.Scanner(
//					new java.io.File("/home/wes/gitworkspace/trainingGround/TEST/T"))) {
//				while (scanner.hasNextLine()) {
//					content.append(scanner.nextLine()).append(System.lineSeparator());
//				}
//			} catch (FileNotFoundException e) {
...
//	}
	...
	public void runJson(String string, boolean forward) {
		...
		new FlowPreprocessor().process((ArrayList<Token>) tokens);
